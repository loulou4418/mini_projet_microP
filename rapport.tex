...
Dans un premier temps on crée un nouveau projet de type "GCC C ASF Board project". Cela génère une arborescence de fichiers dont un main.c. Ce dernier est étudié de manière globale puis affinée par étape dans la section suivante. L'affinage permettra de citer une partie non exhaustive du code constituant la bibliothèque ASF utilisée dans notre exemple basique.
