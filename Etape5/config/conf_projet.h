...
#define DAC_CTRLA_SWRST_NO             (0x0ul << DAC_CTRLA_SWRST_Pos)
#define DAC_CTRLB_BDWP_NO              (0x0ul << DAC_CTRLB_BDWP_Pos)
#define DAC_CTRLB_VPD_NO               (0x0ul << DAC_CTRLB_VPD_Pos)
#define DAC_CTRLB_LEFTADJ_NO           (0x0ul << DAC_CTRLB_LEFTADJ_Pos)
#define DAC_CTRLB_IOEN_NO              (0x0ul << DAC_CTRLB_IOEN_Pos)
